// File: src/components/CreateMaterialForm.js (Dengan Tombol Batal)
'use client';
...
export default function CreateMaterialForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-lg p-8 space-y-4 bg-white rounded-lg shadow-md">
      ...
      {/* --- Perubahan di Sini: Menambahkan Tombol Batal --- */}
      <div className="flex items-center gap-4 pt-4 border-t">
        <button
          type="button" // Penting: type="button" agar tidak mengirim form
