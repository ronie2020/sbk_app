// File: src/app/rekap-nilai/page.js (Versi Final dengan arsitektur baru)

import { createClient } from '@/utils/supabase/server'; // <-- Menggunakan client server baru
...
export default async function RekapNilaiPage() {
  const supabase = createClient(); // <-- Membuat client dengan cara baru
